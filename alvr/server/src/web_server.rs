        ...
        "/api/dashboard-request" => {
            if let Ok(request) = from_request_body::<ServerRequest>(request).await {
                match request {
                    ...
                    ServerRequest::COF0sub => unsafe {crate::COF0sub()},
                    ServerRequest::COF1sub => unsafe {crate::COF1sub()},
                    ServerRequest::COF0add => unsafe {crate::COF0add()},
                    ServerRequest::COF1add => unsafe {crate::COF1add()},
                    ServerRequest::Setmap => unsafe {crate::Setmap()},
                    ...
                    ServerRequest::Usertypes=>unsafe {crate::Usertypes()},
